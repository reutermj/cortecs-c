...
//     void *target = cortecs_gc_alloc(128);
//     void *unroot_reachable = cortecs_gc_alloc(128);
//     cortecs_gc_add(target, unroot_reachable);

//     ecs_progress(world, 0);

//     TEST_ASSERT_FALSE(cortecs_gc_is_alive(unroot_reachable));
...
//     void *rooted = cortecs_gc_alloc(128);
//     cortecs_gc_add_root(target, rooted);

//     ecs_progress(world, 0);

//     TEST_ASSERT_FALSE(cortecs_gc_is_alive(rooted));
...
//     void *root_reachable = cortecs_gc_alloc(128);
//     cortecs_gc_add(rooted, root_reachable);

//     ecs_progress(world, 0);

//     TEST_ASSERT_FALSE(cortecs_gc_is_alive(rooted));
//     TEST_ASSERT_FALSE(cortecs_gc_is_alive(root_reachable));
